...
parser.add_argument('--gpus', default='1', type=str) # well most of the cases
parser.add_argument('--log-dir', default='tflog', type=str)
parser.add_argument('-b', '--batch-size', default=128, type=int) # 20190509
...
parser.add_argument('--img-model', default='tsn', type=str)
...
parser.add_argument('--save-dir', default="/home/links/ym310/DeepHash/DeepHash/model/dch_inception/models/", type=str)
parser.add_argument('--data-dir', default="/home/links/ym310/DeepHash/data/", type=str)
...
label_dims = {'cifar10': 10, 'cub': 200, 'nuswide_81': 81, 'coco': 80} # 32x32 color images - 10 object classes
...
query_img, database_img = dataset.import_validation(data_root, args.img_te, args.img_db) # test_image, database_image

if not args.evaluate:
    train_img = dataset.import_train(data_root, args.img_tr) #/DeepHash/data_provider/image/__init__.py

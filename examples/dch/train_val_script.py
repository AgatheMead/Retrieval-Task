...
import model.dch_vgg16 as model
...
parser.add_argument('-b', '--batch-size', default=64, type=int) # 20190423 alexnet-128 // vgg16-64
...
parser.add_argument('--img-model', default='vgg16', type=str)
